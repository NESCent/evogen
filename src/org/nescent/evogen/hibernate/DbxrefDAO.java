 ...
 * @see org.nescent.evogen.hibernate.Dbxref
...
public class DbxrefDAO extends BaseHibernateDAO {
    ...
    public Dbxref findById( java.lang.Integer id) {
        ...
        try {
            Dbxref instance = (Dbxref) getSession()
                    .get("org.nescent.evogen.hibernate.Dbxref", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Dbxref instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("org.nescent.evogen.hibernate.Dbxref")
	...
	public List findByDbname(Object dbname) {
		return findByProperty(DBNAME, dbname);
	}
